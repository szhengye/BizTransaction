...
@Slf4j
@Service
public class ApplicationService4 extends AbstractBizTran {
    @Autowired
    ...
    public String doService4(String msg) throws BizTranRespErrorException, BizTranTimeOutException {
        log.info("doService4({})",msg);
